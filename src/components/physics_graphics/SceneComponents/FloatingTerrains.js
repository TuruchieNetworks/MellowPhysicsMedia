...
const FloatingTerrains = ({ width = window.innerWidth, height = window.innerHeight, particleCount = 140}) => {
  ...
  useEffect(() => {
    ...
    const texturedShaderMaterial = shaderManager.wiredCityTerrainSDFMaterial; // tunnelTerrainMaterial; // cityTerrainMaterial; // wiredCityTerrainSDFMaterial; // flyingTerrainMaterial; //lyingTerrainMaterial;
    ...
    geoUtils.createMultifacedBoundaryBox(params.boundary + params.boundary / 2);
