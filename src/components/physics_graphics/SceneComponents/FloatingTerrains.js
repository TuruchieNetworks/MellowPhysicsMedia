...
const FloatingTerrains = ({ width = window.innerWidth, height = window.innerHeight, particleCount = 14}) => {
  ...
  useEffect(() => {
    ...
    geoUtils.createMultifacedBoundaryBox(params.boundary + params.boundary / 2, 0.0);
    ...
    const animate = (time = params.time) => {
      ...
      // holyGrailShader.uniforms.time.value += 0.1;
      // shaderManager.landScapeManager.landScapeShader.uniforms.time.value = time;
      // shaderManager.parkCityManager.fortressMansionShader.uniforms.time.value = time + params.deltaTime;
      // }
...
export default FloatingTerrains;
    ...
    //  {
    //   top: shaderManager.terrainManager.wiredCityTerrainSDFShader,
    //   bottom: shaderManager.terrainManager.wiredCityTerrainSDFShader,
    //   left: shaderManager.tunnelManager.tubeCityShader,
    //   right: shaderManager.skylineManager.ceasarsShader, // skylineManager.glassSkylineShshaders.// front: shaderManager.lucentManager.blendedLucentShader,
    //   front: shaderManager.parkCityManager.holyGrailShader, //landScapeManager.landScapeShader, //sandyPlainManager.dancingCreatureShader,//sandGalaxyMaterial,//dragonCityManager.dragonCityTerrainShader, //lucentManager.blendedLucentShader, // dragonCityManager.flyingDragonTerrainShader, //dragonCityTerrainShader, //terrestialManager.terrestialDragonShader,
    //   back: shaderManager.terrestialManager.terrestialDragonShader,//terrestialMosaicShader//terrestialDragonShader, //lucentManager.blendedLucentShader,
    // });
